...
void iwmClock::iwm_status(iwm_decoded_cmd_t cmd)
{
    ...
    case CMD::APETIME_SETTZ_ALT2:
    case CMD::APETIME_SETTZ_ALT: {
        use_alternate_tz = status_code == CMD::APETIME_SETTZ_ALT;
    ...
    case CMD::APETIME_GET_PRODOS_ALT: {
        use_alternate_tz = status_code == CMD::APETIME_GET_PRODOS_ALT;
    ...
    case CMD::APETIME_GET_SOS_ALT: {
        use_alternate_tz = status_code == CMD::APETIME_GET_SOS_ALT;
    ...
    case CMD::APETIME_GET_ISO_LOCAL_ALT: {
        use_alternate_tz = status_code == CMD::APETIME_GET_ISO_LOCAL_ALT;
    ...
    case CMD::APETIME_GET_ISO_UTC_ALT: {
        use_alternate_tz = status_code == CMD::APETIME_GET_ISO_UTC_ALT;
        // utc (zulu)
    ...
    case CMD::APETIME_GET_ATARI_ALT: {
        use_alternate_tz = status_code == CMD::APETIME_GET_ATARI_ALT;
