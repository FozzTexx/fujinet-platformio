...
const std::unordered_map<fujiCommandID_t, NDevice::Handler> NDevice::dispatch_table = {
    ...
    { CMD::NET_CHANNEL_MODE,     {&NDevice::fujidev_set_parser}             },
    ...
    { CMD::NET_CONTROL,          {&NDevice::fujidev_tcp_control}            },
    { CMD::NET_CLOSE_CLIENT,     {&NDevice::fujidev_tcp_close_client}       },

    { CMD::NET_SET_CHANNEL_MODE, {&NDevice::fujidev_http_set_channel_mode}  },
