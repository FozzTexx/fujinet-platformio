...
bool NetworkProtocolHTTP::open_file_handle()
{
    ...
    switch (aux1_open)
    {
    case RS232_OPEN_READ:        // GET with no headers, filename resolve
    case RS232_OPEN_READWRITE:   // GET with ability to set headers, no filename resolve.
        httpOpenMode = GET;
        break;
    case RS232_OPEN_WRITE:       // WRITE, filename resolve, ignored if not found.
        httpOpenMode = PUT;
        break;
    case RS232_OPEN_HTTP_DELETE: // DELETE with no headers
    case RS232_OPEN_APPEND:      // DELETE with ability to set headers
        httpOpenMode = DELETE;
        break;
    case RS232_OPEN_HTTP_POST:   // POST can set headers, also no filename resolve
    case RS232_OPEN_HTTP_PUT:    // PUT with ability to set headers, no filename resolve
        httpOpenMode = POST;
        break;
    default:
