...
public:
     ...
     * @return PROTOCOL_ERROR::NONE on success, PROTOCOL_ERROR::UNSPECIFIED on error
     */
    protocolError_t special_00(fujiCommandID_t cmd, uint8_t httpChanMode) override { error = NDEV_STATUS::NOT_IMPLEMENTED; return PROTOCOL_ERROR::UNSPECIFIED; }
     ...
     * @return PROTOCOL_ERROR::NONE on success, PROTOCOL_ERROR::UNSPECIFIED on error
     */
    protocolError_t special_40(uint8_t *sp_buf, unsigned short len, fujiCommandID_t cmd) override { error = NDEV_STATUS::NOT_IMPLEMENTED; return PROTOCOL_ERROR::UNSPECIFIED; }
     ...
     */
    protocolError_t special_80(uint8_t *sp_buf, unsigned short len, fujiCommandID_t cmd) override { error = NDEV_STATUS::NOT_IMPLEMENTED; return PROTOCOL_ERROR::UNSPECIFIED; }

    /**
     * @brief perform an idempotent command with DSTATS 0x80, that does not require open channel.
     * @param url The URL object.
     */
    protocolError_t perform_idempotent_80(PeoplesUrlParser *url, fujiCommandID_t cmd) override;
