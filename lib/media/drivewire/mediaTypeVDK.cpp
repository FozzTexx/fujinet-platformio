...
fujiError_t MediaTypeVDK::read(uint32_t blockNum, uint16_t *readcount)
{
...
// Returns FUJI_ERROR::UNSPECIFIED if an error condition occurred
fujiError_t MediaTypeVDK::write(uint32_t blockNum, bool verify)
{
...
// Returns FUJI_ERROR::UNSPECIFIED if an error condition occurred
fujiError_t MediaTypeVDK::format(uint16_t *responsesize)
{
    return FUJI_ERROR::UNSPECIFIED;
}
...
fujiError_t MediaTypeVDK::create(FILE *f, uint32_t numBlocks)
{
